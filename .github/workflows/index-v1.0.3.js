...
function Ke(e) {
    ((!e.__d && (e.__d = true) && _e.push(e) && !Se.__r++) || a1 !== m.debounceRendering) && ((a1 = m.debounceRendering) || R1)(Se);
}
...
function x1(e, t, n, r, a, s, c, l, i, d, h) {
    ...
    for (n.__k = [], _ = 0; _ < q; _++)
        ...
        (u = R[_]) && u.key == null && u.__e && (u.__e == i && ((u.__ = r), (i = Me(u))), ze(u, u, false), (R[_] = null));
...
function Qe(e, t, n, r, a, s, c, l, i, d) {
    ...
    e: if (typeof D == "function")
        try {
            if (
                ...
                if (
                    (D.getDerivedStateFromProps == null && v !== u && _.componentWillReceiveProps != null && _.componentWillReceiveProps(v, W),
                        !_.__e && ((_.shouldComponentUpdate != null && _.shouldComponentUpdate(v, _.__s, W) === false) || t.__v === n.__v))
                ) {
                    for (
                        t.__v !== n.__v && ((_.props = v), (_.state = _.__s), (_.__d = false)),
                        t.__e = n.__e,
                        t.__k = n.__k,
            ...
            if (((_.context = W), (_.props = v), (_.__P = e), (_.__e = false), (R = m.__r), (le = 0), "prototype" in D && D.prototype.render)) {
                for (_.state = _.__s, _.__d = false, R && R(t), h = _.render(_.props, _.state, _.context), K = 0; K < _._sb.length; K++) _.__h.push(_._sb[K]);
                _._sb = [];
            } else
                do(_.__d = false), R && R(t), (h = _.render(_.props, _.state, _.context)), (_.state = _.__s);
                while (_.__d && ++le < 25);
            (_.state = _.__s),
...
function dt(e, t, n, r, a, s, c, l, i) {
    ...
    if (e == null) {
        ...
        (e = a ? document.createElementNS("http://www.w3.org/2000/svg", f) : document.createElement(f, u.is && u)), (s = null), (l = false);
    }
    if (f === null) C === u || (l && e.data === u) || (e.data = u);
        ...
        l ||
            ("value" in u && (g = u.value) !== void 0 && (g !== e.value || (f === "progress" && !g) || (f === "option" && g !== C.value)) && $e(e, "value", g, C.value, false),
                "checked" in u && (g = u.checked) !== void 0 && g !== e.checked && $e(e, "checked", g, C.checked, false));
    }
    return e;
}
...
(z.prototype.forceUpdate = function (e) {
    this.__v && ((this.__e = true), e && this.__h.push(e), Ke(this));
}),
        ...
        var a = function (l, i, d) {
            ...
            return (
                h.forEach(function (C) {
                    if (C.__N) {
                        var u = C.__[0];
                        (C.__ = C.__N), (C.__N = void 0), u !== C.__[0] && (_ = true);
                    }
                }),
...
function A(e) {
    var t = T.context[e.__c],
        n = Be(we++, 9);
    return (n.c = e), t ? (n.__ == null && ((n.__ = true), t.sub(T)), t.props.value) : e.__;
}
...
function Ct(e, t, n) {
    ...
    return (n.default === true || r !== false) && c;
}
    ...
    return (
        ...
        (function (n) {
            for (var r = pe.length; r--;)
                if (pe[r].canRoute(n)) return true;
            return false;
        })(e) &&
        (function (n, r) {
...
function K1(e) {
    for (var t = false, n = 0; n < pe.length; n++) pe[n].routeTo(e) && (t = true);
    return t;
}
...
function It(e) {
    return e.stopImmediatePropagation && e.stopImmediatePropagation(), e.stopPropagation && e.stopPropagation(), e.preventDefault(), false;
}
...
Ee((r1.prototype = new z()), {
    shouldComponentUpdate: function (e) {
        return e.static !== true || e.url !== this.props.url || e.onChange !== this.props.onChange;
    },
    canRoute: function (e) {
...
function g1(e, t) {
    for (var n in e)
        if (n !== "__source" && !(n in t)) return true;
    for (var r in t)
        if (r !== "__source" && e[r] !== t[r]) return true;
    return false;
}
...
((N1.prototype = new z()).isPureReactComponent = true),
...
function X1(e, t, n) {
    return (
        ...
        ((e.__v = null),
            ...
            e.__c && e.__c.__P === t && (e.__e && n.insertBefore(e.__e, e.__d), (e.__c.__e = true), (e.__c.__P = n))),
        e
    );
}
...
(m.unmount = function (e) {
    var t = e.__c;
    t && t.__R && t.__R(), t && e.__h === true && (e.type = null), y1 && y1(e);
}),
            ...
            V(() => {
                (() =>
                    wn(void 0, null, function* () {
                        try {
                            const I = yield Nn();
                            C(I.data.servers), f(I.data.playersMax), $(I.data.players), i(true);
                        } catch (I) {
...
const No = "_wrapper_1fid2_1",
    ...
    rr = ({
        ...
        const {
            ...
            _ = () => {
                if (!e.kits || e.kits.length === 0) return false;
        ...
        return (
            V(() => {
                const i = (d) => {
                    ...
                    a && e.current && !h.includes(e.current) && s(false);
                };
                return (
        ...
        return (
            V(() => {
                const l = (i) => {
                    ...
                    r && n.current && !d.includes(n.current) && a(false);
                };
                return (
...
qe(o(it, {}), document.getElementById("app"));.toString()
